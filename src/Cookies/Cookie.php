...
namespace Fatkulnurk\Session\Cookies;
...
final class Cookie
{
     ...
     * @return static this instance for chaining
     */
    public function setSameSiteRestriction(string $sameSiteRestriction = null): Cookie
    {
     ...
     * @return Cookie
     */
    public static function parse(string $cookieHeader)
    {
    ...
    /*
     * Terinspirasi dari cookie
     * https://github.com/delight-im/PHP-Cookie/blob/master/src/Cookie.php
     * */
}